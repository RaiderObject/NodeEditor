...
from PySide6.QtGui import QPainter, Qt, QMouseEvent, QDragEnterEvent, QDropEvent, QKeyEvent, QWheelEvent
...
class QDMGraphicsView(QGraphicsView):
    ...
    #: qtSignal emitted when cursor position on the `Scene` has changed
    ...
    def mouseReleaseEvent(self, event:QMouseEvent):
        """Dispatch Qt's mouseRelease event to the corresponding function below"""
        if event.button() == Qt.MiddleButton:
    ...
    def middleMouseButtonPress(self, event:QMouseEvent):
        """When a Middle mouse button was pressed"""
    ...
    def middleMouseButtonRelease(self, event:QMouseEvent):
        """When a Middle mouse button was released"""
        fakeEvent = QMouseEvent(event.type(), event.localPos(), event.screenPos(),
                                Qt.LeftButton, event.buttons() & ~Qt.LeftButton, event.modifiers())
    ...
    def leftMouseButtonPress(self, event:QMouseEvent):
        """When a Left mouse button was pressed"""
    ...
    def leftMouseButtonRelease(self, event:QMouseEvent):
        """When a Left mouse button was released"""
    ...
    def rightMouseButtonPress(self, event:QMouseEvent):
        """When a Right mouse button was pressed"""
        super().mousePressEvent(event)



    def rightMouseButtonRelease(self, event:QMouseEvent):
        """When a Right mouse button was release"""
        super().mouseReleaseEvent(event)
    ...
    def mouseMoveEvent(self, event:QMouseEvent):
        ...
        if self.mode == MODE_EDGE_DRAG:
            # according to the sentry: 'NoneType' object has no attribute 'grEdge'
    ...
    def edgeDragStart(self, item:'QGraphicsItem'):
        ...
        try:
            ...
            print("%s2 ERROR:",e.__class__.__name__ , e)
